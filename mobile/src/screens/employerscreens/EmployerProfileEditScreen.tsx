...
export default function EmployerProfileEditScreen() {
  ...
  const setProfileFromBackend = useEmployerStore(
    (s) => s.setProfileFromBackend
  );
  ...
  return (
     ...
     <FormScreenWrapper>
        ...
        <View style={{ flexDirection: "row", marginTop: 20 }}>
          ...
          <TouchableOpacity
            ...
            onPress={handleUpdate}   // ✅ reuse your existing function
            style={{
              flex: 1,
              backgroundColor: isValid ? theme.primary : theme.disable,
              padding: 14,
              borderRadius: 10,
              alignItems: "center",
              marginLeft: 5,
    ...
    <ConfirmModal
      ...
      theme={theme}
      message="Changes you made will not be saved. Are you sure you want to go back?"
